...
/* smtp-test.php: ONE-TIME test. Visit this page once in your browser:
   https://condolencecardmessages.com/smtp-test.php?to=YOUR-personal@gmail.com
...
$secrets = [];
foreach ([
    dirname($_SERVER['DOCUMENT_ROOT'] ?? __DIR__) . '/condolencecardmessages_private/secrets.php',
...
$cfg = [
    ...
    'from_name' => 'Condolence Card Messages',
];
if (empty($cfg['pass'])) { echo "STOP: smtp_pass is not set in secrets.php. Add it, then retry.\n"; exit; }

$err = null;
$ok = smtp_send($cfg, $to, 'SMQ SMTP test', "This is a test from condolencecardmessages.com.\nIf you can read this, SMTP works.\n", $err);
