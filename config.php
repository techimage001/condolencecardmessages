<?php
/* ============================================================
   CONDOLENCE CARD MESSAGES: CONFIGURATION
...
$SMQ_SECRET_PATHS = [
    dirname(__DIR__) . '/condolencecardmessages_private/secrets.php',
    dirname(__DIR__, 2) . '/condolencecardmessages_private/secrets.php',
    __DIR__ . '/../condolencecardmessages_private/secrets.php',
];
...
define('NOTIFY_EMAIL', (string)($SMQ_SECRETS['NOTIFY_EMAIL'] ?: 'info@condolencecardmessages.com'));

/* Public, non-secret settings. Safe in git. */
define('SITE_URL', 'https://condolencecardmessages.com');
define('FROM_EMAIL', 'no-reply@condolencecardmessages.com');

/* Database: OUTSIDE public_html so deploys can never delete the list. */
define('DB_PRIMARY_DIR', dirname(__DIR__) . '/condolencecardmessages_private');
