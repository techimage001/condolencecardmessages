<?php
/* Condolence Card Messages: email confirmation landing page.
        ...
        try {
            ...
            if ($row) {
                ...
                if ((int)$row['verified'] === 1) {
                    ...
                    $state = 'done';
                    global $SMQ_SECRETS; send_mail_smart($SMQ_SECRETS, NOTIFY_EMAIL, 'New verified Condolence Card Messages signup', "Verified signup: {$email}\nTime (UTC): " . gmdate('c') . "\n");
                }
            }
...
<title><?= htmlspecialchars($title, ENT_QUOTES) ?>: Condolence Card Messages</title>
...
<p class="note center" style="margin-top:18px">Questions: <a href="mailto:info@condolencecardmessages.com">info@condolencecardmessages.com</a></p>
</div></main>

<footer class="mega"><div class="wrap">
<p class="legal">&copy; 2026 Condolence Card Messages &middot; <a href="/">Home</a> &middot; <a href="/privacy.html">Privacy policy</a> &middot; <a href="/terms.html">Terms of use</a> &middot; <a href="/contact.html">Contact</a></p>
</div></footer>
