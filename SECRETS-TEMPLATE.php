<?php
/* ============================================================
   SECRETS TEMPLATE FOR CONDOLENCE CARD MESSAGES

   DO NOT PUT THIS FILE IN public_html AND DO NOT COMMIT IT TO GIT.

   Create it by hand in Hostinger File Manager at:
       domains/condolencecardmessages.com/condolencecardmessages_private/secrets.php
...
return [
    ...
    'NOTIFY_EMAIL' => 'info@condolencecardmessages.com',
];
