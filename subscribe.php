<?php
/* Condolence Card Messages: signup collector (V3).
...
$subject = 'Confirm your free Condolence Card Messages account';
$body = "Welcome to Condolence Card Messages.\n\n"
