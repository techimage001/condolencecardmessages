<?php
/* Condolence Card Messages: leads admin (V3).
...
if ($authed) {
    ...
    if ($pdo && ($_GET['export'] ?? '') === 'csv') {
        ...
        header('Content-Disposition: attachment; filename="condolencecardmessages-verified-leads.csv"');
...
<title>Leads admin: Condolence Card Messages</title>
<style>
...
<body>
<h1>Condolence Card Messages: leads admin</h1>
<?php if (!$authed): ?>
