# Condolence Card Messages V6 (July 2026)
...
- The column blocks (Quote Categories, Free Tools, Why Condolence Card Messages, Site)
...
# Condolence Card Messages V5 (July 2026)
...
- Each downloaded/shared PNG embeds tEXt metadata: Title (the quote), Description,
  Author, Copyright, Source (https://condolencecardmessages.com), Software.
...
## SMTP
- Unchanged. Authenticated SMTP stays scoped to condolencecardmessages.com (no porting).
...
# Condolence Card Messages: major feature build (July 2026)
